...
const Reusable = (props) => {
  return (
    <div className="mt-8 flex flex-col gap-2 items-center group min-w-12">
      <props.icon
        className="text-4xl group-hover:text-red-500 cursor-pointer group-hover:translate-y-[-8px] transform 
        transition-all duration-500 ease-in-out text-gray-600"
      />
      <p className="font-semibold pt-1">{props.t1}</p>
      <p className="text-gray-400 text-sm">{props.t2}</p>
    </div>
  );
};
const Footer = () => {
      ...
      <div className="grid grid-cols-2 sm:flex justify-center sm:flex-wrap gap-6 md:gap-12 py-5 sm:py-12 border border-gray-200 bg-white mt-5 ">
        {[
          { icon: FiTruck, t1: "Fast Delivery", t2: "Within 24 hours" },
          {
            ...
            t1: "30 Days Returns",
            t2: "For an Exchange Product",
          },
          {
            icon: FiCreditCard,
            t1: "Secured Payment",
            t2: "Payment Cards Accepted",
          },
          { icon: FiGift, t1: "Special Gifts", t2: "Our First Product Order" },
          {
            icon: FiHeadphones,
            t1: "Support 24/7",
            t2: "Contact us Anytime",
          },
        ].map((item, index) => (
          <Reusable key={index} icon={item.icon} t1={item.t1} t2={item.t2} />
        ))}
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-600 leading-relaxed mb-6 text-sm lg:text-base">
                ...
                bring convenience right to your doorstep with our premium
                shopping experience.
              </p>
