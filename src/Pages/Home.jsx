  ...
  return (
    <div className=" w-68 border-2 h-auto flex-col rounded-xl overflow-hidden border-zinc-100 shadow-2xl relative">
      ...
      <div className="p-5  flex flex-col gap-2">
        ...
        <button className="border-2 w-full border-blue-700 hover:border-none text-blue-700 hover:text-white hover:bg-black p-1.5 flex justify-center items-center gap-3 mt-3.5 rounded-sm"><i class="fa-solid fa-cart-shopping"></i><span>Add to cart</span></button>
      </div>
