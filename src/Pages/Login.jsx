  ...
  return (
    <form className="flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-700">
      <h1 className="text-center inline-flex mt-10 mb-2 text-3xl tracking-tighter">
        <span className='text-blue-400'>Log </span> <span>in</span>
      </h1>
      <input
        type="email"
      ...
      <div className="flex justify-between w-full text-sm mt-[-8px] font-semibold text-blue-400">
        <p className='hover:text-gray-500 cursor-pointer'>Forgot you password ?</p>
        <Link to='/register'>Create account</Link>
      </div>
      <button className='mt-5 border w-full py-1 text-lg rounded-lg text-blue-400  hover:text-white hover:bg-blue-400 cursor-pointer'>Login</button>
    </form>
  );
}
